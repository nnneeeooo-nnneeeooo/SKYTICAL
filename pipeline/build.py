...
L = {
    "zh": {
        ...
        "incSub": "自動彙整全球民航與軍用航空事故及事件，資料來自各國調查機關與專業追報來源，每小時更新。",
        "incCountLabel": "筆紀錄",
        "incWeeklySerious": "本週嚴重事件",
        "incReadEvent": "閱讀事件",
        "incNote": "* 分級於適用時參考 ICAO Annex 13；軍用及其他國家航空器依公開資料分類。",
        ...
        "radarTitle": "台灣民航雷達",
        "radarSub": "公開 ADS-B 近即時觀測圖，顯示台灣周邊民航機的 ICAO／IATA 航班代碼、航線、機型、高度、速度與航向。",
    ...
    "en": {
        ...
        "incSub": "Automatically aggregated civil and military aviation accidents and incidents, from state investigators and specialist trackers. Updated hourly.",
        "incCountLabel": "records",
        "incWeeklySerious": "Serious events this week",
        "incReadEvent": "Read event",
        "incNote": "* ICAO Annex 13 classifications apply where relevant; military and other state-aircraft events follow public-source classification.",
        ...
        "radarSub": "A near-live public ADS-B view of civil aircraft around Taiwan, with ICAO/IATA flight codes, routes, type, altitude, speed and heading.",
