...
def main() -> None:
    ...
    assert raw["updatedThrough"] == "2026-09-14"
    assert len(raw["entries"]) == 134
    ...
    for lang, view in (("zh", zh), ("en", en)):
        ...
        assert len(re.findall(r'class="changelog-entry"', html)) == 134
